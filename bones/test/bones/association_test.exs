defmodule Bones.AssociationTest do
  ...
  describe "etf_moeda_associations" do
    ...
    test "get_etf_moeda_association!/1 returns the etf_moeda_association with given id" do
      etf_moeda_association = etf_moeda_association_fixture()
      assert Association.get_etf_moeda_association!(etf_moeda_association.id) == etf_moeda_association
    end
    ...
    test "create_etf_moeda_association/1 with valid data creates a etf_moeda_association" do
      ...
      assert {:ok, %EtfMoedaAssociation{} = etf_moeda_association} = Association.create_etf_moeda_association(valid_attrs)
    ...
    test "create_etf_moeda_association/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} = Association.create_etf_moeda_association(@invalid_attrs)
    end
    ...
    test "update_etf_moeda_association/2 with valid data updates the etf_moeda_association" do
      ...
      assert {:ok, %EtfMoedaAssociation{} = etf_moeda_association} = Association.update_etf_moeda_association(etf_moeda_association, update_attrs)
    ...
    test "update_etf_moeda_association/2 with invalid data returns error changeset" do
      etf_moeda_association = etf_moeda_association_fixture()
      assert {:error, %Ecto.Changeset{}} = Association.update_etf_moeda_association(etf_moeda_association, @invalid_attrs)
      assert etf_moeda_association == Association.get_etf_moeda_association!(etf_moeda_association.id)
    end

    test "delete_etf_moeda_association/1 deletes the etf_moeda_association" do
      etf_moeda_association = etf_moeda_association_fixture()
      assert {:ok, %EtfMoedaAssociation{}} = Association.delete_etf_moeda_association(etf_moeda_association)
      assert_raise Ecto.NoResultsError, fn -> Association.get_etf_moeda_association!(etf_moeda_association.id) end
    end
